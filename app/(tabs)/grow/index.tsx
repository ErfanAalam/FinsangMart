...
import { ChevronRight, Sparkles, TrendingUp, Star, Zap, Crown } from 'lucide-react-native';
import { useEffect, useState } from 'react';
import { ActivityIndicator, FlatList, Image, ScrollView, StyleSheet, Text, TouchableOpacity, View, Dimensions, StatusBar } from 'react-native';
    ...
    return (
      <View style={styles.loadingContainer}>
        ...
        <SafeAreaView style={styles.loadingContent}>
          ...
          <Text style={styles.loadingSubtitle}>Curating the best growth resources for you</Text>
        </SafeAreaView>
      </View>
    );
  }
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.featuredHeader}>
              <View style={styles.featuredTitleContainer}>
                ...
                <View>
                  ...
                  <Text style={styles.featuredSubtitle}>Fresh content updated daily</Text>
                </View>
              </View>
              ...
              >
                ...
                <View style={styles.featuredContent}>
                  ...
                  <View style={styles.featuredMeta}>
                    <Text style={styles.featuredMetaText}>Updated recently</Text>
        ...
        <View style={styles.categoriesWrapper}>
          <View style={styles.categoriesHeader}>
            ...
            <Text style={styles.categoriesSubtitle}>Curated collections for every growth journey</Text>
          </View>

          {categories.filter(category => posters[category.id] && posters[category.id].length > 0).map((category, categoryIndex) => (
            <View key={category.id} style={styles.categorySection}>
              <View style={styles.categoryHeaderContainer}>
                <TouchableOpacity
                  onPress={() => router.push({ pathname: '/(tabs)/grow/category', params: { ...category } })}
                  style={styles.categoryHeader}
                  activeOpacity={0.8}
                >
                  <View style={styles.categoryTitleContainer}>
                    <View style={[styles.categoryIconContainer, { backgroundColor: getCategoryColor(categoryIndex) }]}>
                    ...
                    <View style={styles.categoryTextContainer}>
                      ...
                      <Text style={styles.categorySubtitle}>{posters[category.id].length} resources available</Text>
                    </View>
                  </View>
              ...
              <FlatList
                ...
                renderItem={({ item, index }) => (
                  <TouchableOpacity
                    style={[styles.categoryCard, { marginLeft: index === 0 ? 24 : 16 }]}
                    onPress={() => router.push({ pathname: '/(tabs)/grow/poster', params: { ...item } })}
                    activeOpacity={0.9}
                  >
                    ...
                    <View style={[styles.categoryCardAccent, { backgroundColor: getCategoryColor(categoryIndex) }]} />
