...
import { ActivityIndicator, Dimensions, FlatList, Image, Modal, Text, TouchableOpacity, View, StyleSheet, StatusBar, ScrollView } from 'react-native';
import { LinearGradient } from 'expo-linear-gradient';
import YoutubePlayer from 'react-native-youtube-iframe';
import Colors from '../../constants/Colors';
import { fetchCategories, fetchFeaturedVideos, fetchVideosByCategory } from '../../lib/trainingApi';
  ...
  return (
    <View style={styles.container}>
      ...
      {/* <View style={styles.headerSection}>
        ...
        <Text style={styles.headerSubtitle}>Enhance your skills with our content</Text>
      </View> */}
          ...
          <View style={styles.categoriesGrid}>
            {categories.map((item, index) => (
              <TouchableOpacity
                ...
                onPress={() => router.push({ pathname: '/training/CategoryVideos', params: { category: JSON.stringify(item) } })}
                activeOpacity={0.8}
              >
