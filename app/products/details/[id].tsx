...
import { ActivityIndicator, Dimensions, Image, Modal, SafeAreaView, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: Colors.white }}>
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 90 }}>
                ...
                {videoId && videoThumbnail ? (
                    <TouchableOpacity onPress={() => setVideoVisible(true)} style={styles.videoBg} activeOpacity={0.8}>
                        <Image
                        ...
                        <View style={styles.playButton}>
                            <Text style={styles.playIcon}><PlayCircle color='white' /></Text>
                        </View>
                    </TouchableOpacity>
                ) : null}
                ...
                >
                    <View style={{ flex: 1, backgroundColor: '#000', justifyContent: 'center' }}>
                        <TouchableOpacity onPress={() => setVideoVisible(false)} style={{ position: 'absolute', top: 40, right: 20, zIndex: 1 }}>
                        ...
                        {videoId ? (
                            ...
                            <Text style={{ color: '#fff', textAlign: 'center', marginTop: 100 }}>Video unavailable</Text>
                        )}
                    </View>
                </Modal>
                ...
                <View style={styles.profitCard}>
                    ...
                    {/* View Terms Link */}
                    <TouchableOpacity onPress={() => router.push({ pathname: '/products/details/[id]/terms', params: { id: idStr } })}>
                ...
                <View style={styles.iconsRow}>
                    {icons.map((icon, i) => (
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                if (icon.label === 'Card Benefits') router.push({ pathname: '/products/details/[id]/card-benefits', params: { id: idStr } });
                                else if (icon.label === 'Application Process') router.push({ pathname: '/products/details/[id]/application-process', params: { id: idStr } });
                                else if (icon.label === 'Eligibility Criteria') router.push({ pathname: '/products/details/[id]/eligibility-criteria', params: { id: idStr } });
                                else if (icon.label === 'Training & Learning') router.push({ pathname: '/products/details/[id]/training', params: { id: idStr } });
                                else if (icon.label === 'Marketing Resources') router.push({ pathname: '/products/details/[id]/marketing-resources', params: { id: idStr } });
                                else if (icon.label === 'Help & Support') router.push({ pathname: '/products/details/[id]/help-support', params: { id: idStr }});
                            }}
                            activeOpacity={0.7}
                        >
            ...
            <View style={styles.bottomBar}>
                <TouchableOpacity style={styles.sellNowButton} onPress={() => shareProduct({ product, user: userDetails })}>
